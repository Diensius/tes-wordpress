...
var Kata_Plus_Builders_Manager = (function ($) {
    return {
        ...
        ModifyAddNewBuilderURL: function () {
            var href =
                $(".page-title-action").attr("href") + "&builder=" + kata_builders_localize.builder_branch;
        ...
        ModifyAddNewTranslationURL: function () {
            if ($(".pll_icon_add").length) {
                var href =
                    $(".pll_icon_add").attr("href") + "&builder=" + kata_builders_localize.builder_branch;
        ...
        SetDefaultPrimaryBuilder: function () {
            $(".update-kata-builders .button ").on("click", function (e) {
                var $this = $(this);
                e.preventDefault();
                $this.closest(".update-kata-builders").addClass("notice-alt updating-message");
                ...
                $.ajax({
                    ...
                    success: function (response, data) {
                        ...
                        setTimeout(function () {
                            $this.closest(".update-kata-builders").find(".notice-dismiss").trigger("click");
                            location.reload();
                        }, 2000);
                    },
                    error: function (response) {
