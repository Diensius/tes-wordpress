	...
	class Kata_Plus_Builders_Manager extends Kata_Plus_Builders_Base {
		...
		public function add_new_builder( $post_ID, $post, $update ) {
			...
			switch ( $builder ) {
				...
				case 'kata_404':
					$content = Kata_Plus_Pro_404_Builder::get_instance()->default_content;
					break;
				case 'kata_archive':
					$content = Kata_Plus_Pro_Archive_Builder::get_instance()->default_content;
					break;
				case 'kata_author':
					$content = Kata_Plus_Pro_Author_Builder::get_instance()->default_content;
					break;
				case 'kata_single_course':
					$content = Kata_Plus_Pro_Single_Course_Builder::get_instance()->default_content;
					break;
				case 'kata_archive_portfolio':
					$content = Kata_Plus_Pro_Portfolio_Archive_Builder::get_instance()->default_content;
					break;
				case 'kata_search':
					$content = Kata_Plus_Pro_Search_Builder::get_instance()->default_content;
					break;
				case 'kata_single_post':
					$content = Kata_Plus_Pro_Single_Builder::get_instance()->default_content;
					break;
				case 'kata_single_portfolio':
					$content = Kata_Plus_Pro_Single_Portfolio_Builder::get_instance()->default_content;
					break;
				case 'kata_sticky_header':
					$content = Kata_Plus_Pro_Sticky_Header_Builder::get_instance()->default_content;
					break;
				case 'kata_blog':
					$content = Kata_Plus_Blog_Builder::get_instance()->default_content;
					break;
				case 'kata_footer':
					$content = Kata_Plus_Footer_Builder::get_instance()->default_content;
					break;
				case 'kata_header':
					$content = Kata_Plus_Header_Builder::get_instance()->default_content;
					break;
		...
		public function update_builders() {
			...
			if ( $update_builders && $kata_options['updates']['builders']['primary'] != 'updated' ) {
				...
				$ids = [
					...
					'kata_blog'				 => Kata_Plus_Pro_Single_Course_Builder::get_instance()->get_post_by_title( 'Kata Blog' ),
					'kata_footer'			 => Kata_Plus_Pro_Portfolio_Archive_Builder::get_instance()->get_post_by_title( 'Kata Footer' ),
					'kata_header'			 => Kata_Plus_Pro_Search_Builder::get_instance()->get_post_by_title( 'Kata Header' ),
					'kata_search'			 => Kata_Plus_Pro_Single_Builder::get_instance()->get_post_by_title( 'Kata Search' ),
					'kata_single_post'		 => Kata_Plus_Pro_Single_Portfolio_Builder::get_instance()->get_post_by_title( 'Kata Single' ),
					'kata_single_portfolio'	 => Kata_Plus_Pro_Sticky_Header_Builder::get_instance()->get_post_by_title( 'Kata Single Portfolio' ),
					'kata_sticky_header'	 => Kata_Plus_Blog_Builder::get_instance()->get_post_by_title( 'Kata Sticky Header' ),
					'kata_single_course'	 => Kata_Plus_Footer_Builder::get_instance()->get_post_by_title( 'Single Course' ),
					'kata_archive_portfolio' => Kata_Plus_Header_Builder::get_instance()->get_post_by_title( 'Kata Portfolio Archive' ),
				];
